 ...
 */
@Entity
@Table(name = "BBAS_SINGLE_PROVINCE_OCTETS_WARN", schema = "SDFS", catalog = "")
@IdClass(BbasSingleProvinceOctetsWarnEntityPK.class)
public class BbasSingleProvinceOctetsWarnEntity {
    ...
    public boolean equals(Object o) {
        ...
        BbasSingleProvinceOctetsWarnEntity that = (BbasSingleProvinceOctetsWarnEntity) o;
