 ...
 */
@Entity
@Table(name = "BBAS_XSS_INJECTION_WARN", schema = "SDFS", catalog = "")
public class BbasXssInjectionWarnEntity {
    ...
    public boolean equals(Object o) {
        ...
        BbasXssInjectionWarnEntity that = (BbasXssInjectionWarnEntity) o;
