...
@Entity
@Table(name = "BBAS_ALL_USER_OCTETS_WARN1", schema = "SDFS", catalog = "")
public class BbasAllUserOctetsWarn1Entity {
    ...
    public boolean equals(Object o) {
        ...
        BbasAllUserOctetsWarn1Entity that = (BbasAllUserOctetsWarn1Entity) o;
