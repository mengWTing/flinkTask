...
@Entity
@Table(name = "BBAS_SINGLE_SYSTEM_USERCOUNT_REGRESSION1", schema = "SDFS", catalog = "")
@IdClass(BbasSingleSystemUsercountRegression1EntityPK.class)
public class BbasSingleSystemUsercountRegression1Entity {
    ...
    public boolean equals(Object o) {
        ...
        BbasSingleSystemUsercountRegression1Entity that = (BbasSingleSystemUsercountRegression1Entity) o;
