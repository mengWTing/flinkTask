...
import cn.ffcs.is.mss.analyzer.flink.regression.HoltWintersProvinceRegression.HWSingleProvinceRegression
import cn.ffcs.is.mss.analyzer.flink.regression.HoltWintersSystemRegression.HWSingleSystemRegression
...
object RegressionAll {
  def main(args: Array[String]): Unit = {
    ...
    val singleProvinceOperationModelStream = operationModelStream
      .filter(tuple => !"未知地点".equals(tuple._3)).setParallelism(3)
      .keyBy(2)
      .timeWindow(Time.minutes(1), Time.minutes(1))
      .reduce((o1, o2) => {
  ...
  class HWSingleProvinceRegression extends ProcessFunction[(Long, String, String, Long, Long, Set[String]), (Object,
    ...
    val aggregationsMap = mutable.Map[Aggregation, (Class[_ <: Object], Class[_ <: Object])]()
