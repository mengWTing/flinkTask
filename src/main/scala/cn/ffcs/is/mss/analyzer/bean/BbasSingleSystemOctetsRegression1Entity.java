...
@Entity
@Table(name = "BBAS_SINGLE_SYSTEM_OCTETS_REGRESSION1", schema = "SDFS", catalog = "")
@IdClass(BbasSingleSystemOctetsRegression1EntityPK.class)
public class BbasSingleSystemOctetsRegression1Entity {
    ...
    public boolean equals(Object o) {
        ...
        BbasSingleSystemOctetsRegression1Entity that = (BbasSingleSystemOctetsRegression1Entity) o;
