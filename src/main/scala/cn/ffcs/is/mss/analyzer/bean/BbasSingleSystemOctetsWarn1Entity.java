...
@Entity
@Table(name = "BBAS_SINGLE_SYSTEM_OCTETS_WARN1", schema = "SDFS", catalog = "")
@IdClass(BbasSingleSystemOctetsWarn1EntityPK.class)
public class BbasSingleSystemOctetsWarn1Entity {
    ...
    public boolean equals(Object o) {
        ...
        BbasSingleSystemOctetsWarn1Entity that = (BbasSingleSystemOctetsWarn1Entity) o;
