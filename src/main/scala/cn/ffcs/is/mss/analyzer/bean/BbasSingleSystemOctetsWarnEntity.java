 ...
 */
@Entity
@Table(name = "BBAS_SINGLE_SYSTEM_OCTETS_WARN", schema = "SDFS", catalog = "")
@IdClass(BbasSingleSystemOctetsWarnEntityPK.class)
public class BbasSingleSystemOctetsWarnEntity {
    ...
    public boolean equals(Object o) {
        ...
        BbasSingleSystemOctetsWarnEntity that = (BbasSingleSystemOctetsWarnEntity) o;
