 ...
 */
@Entity
@Table(name = "BBAS_SYSTEM_PORT_SOURCE_WARN", schema = "SDFS", catalog = "")
public class BbasSystemPortSourceWarnEntity {
    ...
    public boolean equals(Object o) {
        ...
        BbasSystemPortSourceWarnEntity that = (BbasSystemPortSourceWarnEntity) o;
