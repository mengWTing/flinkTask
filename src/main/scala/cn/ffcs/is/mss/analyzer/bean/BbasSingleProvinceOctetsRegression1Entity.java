...
@Entity
@Table(name = "BBAS_SINGLE_PROVINCE_OCTETS_REGRESSION1", schema = "SDFS", catalog = "")
@IdClass(BbasSingleProvinceOctetsRegression1EntityPK.class)
public class BbasSingleProvinceOctetsRegression1Entity {
    ...
    public boolean equals(Object o) {
        ...
        BbasSingleProvinceOctetsRegression1Entity that = (BbasSingleProvinceOctetsRegression1Entity) o;
