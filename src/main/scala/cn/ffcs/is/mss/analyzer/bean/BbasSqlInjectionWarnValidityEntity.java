...
/**
 * @author PlatinaBoy
 * @title BbasSqlInjectionWarnValidityEntity
 * @date 2021-03-24 09:19
 * @description
 * @update [no][date YYYY-MM-DD][name][description]
 */
@Entity
@Table(name = "BBAS_SQL_INJECTION_WARN_VALIDITY", schema = "SDFS", catalog = "")
public class BbasSqlInjectionWarnValidityEntity {
    ...
    public boolean equals(Object o) {
        ...
        BbasSqlInjectionWarnValidityEntity that = (BbasSqlInjectionWarnValidityEntity) o;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(warnDatetime, username, loginSystem, destinationIp, loginPlace, sourceIp, url, formValue, injectionValue, httpStatus, packageTxt, validity, packageName);
    }
}
