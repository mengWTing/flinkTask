 ...
 */
@Entity
@Table(name = "BBAS_SINGLE_SYSTEM_USERCOUNT_REGRESSION", schema = "SDFS", catalog = "")
@IdClass(BbasSingleSystemUsercountRegressionEntityPK.class)
public class BbasSingleSystemUsercountRegressionEntity {
    ...
    public boolean equals(Object o) {
        ...
        BbasSingleSystemUsercountRegressionEntity that = (BbasSingleSystemUsercountRegressionEntity) o;
