 ...
 */
@Entity
@Table(name = "BBAS_ALL_USER_CONNCOUNT_WARN", schema = "SDFS", catalog = "")
public class BbasAllUserConncountWarnEntity {
    ...
    public boolean equals(Object o) {
        ...
        BbasAllUserConncountWarnEntity that = (BbasAllUserConncountWarnEntity) o;
