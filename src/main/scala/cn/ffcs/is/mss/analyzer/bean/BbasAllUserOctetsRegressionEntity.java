 ...
 */
@Entity
@Table(name = "BBAS_ALL_USER_OCTETS_REGRESSION", schema = "SDFS", catalog = "")
public class BbasAllUserOctetsRegressionEntity {
    ...
    public boolean equals(Object o) {
        ...
        BbasAllUserOctetsRegressionEntity that = (BbasAllUserOctetsRegressionEntity) o;
