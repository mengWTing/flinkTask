...
@Entity
@Table(name = "BBAS_SINGLE_PROVINCE_USERCOUNT_REGRESSION1", schema = "SDFS", catalog = "")
@IdClass(BbasSingleProvinceUsercountRegression1EntityPK.class)
public class BbasSingleProvinceUsercountRegression1Entity {
    ...
    public boolean equals(Object o) {
        ...
        BbasSingleProvinceUsercountRegression1Entity that = (BbasSingleProvinceUsercountRegression1Entity) o;
