...
@Entity
@Table(name = "BBAS_ALL_USER_USERCOUNT_WARN1", schema = "SDFS", catalog = "")
public class BbasAllUserUsercountWarn1Entity {
    ...
    public boolean equals(Object o) {
        ...
        BbasAllUserUsercountWarn1Entity that = (BbasAllUserUsercountWarn1Entity) o;
