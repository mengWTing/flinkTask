 ...
 */
@Entity
@Table(name = "BBAS_SINGLE_PROVINCE_OCTETS_REGRESSION", schema = "SDFS", catalog = "")
@IdClass(BbasSingleProvinceOctetsRegressionEntityPK.class)
public class BbasSingleProvinceOctetsRegressionEntity {
    ...
    public boolean equals(Object o) {
        ...
        BbasSingleProvinceOctetsRegressionEntity that = (BbasSingleProvinceOctetsRegressionEntity) o;
