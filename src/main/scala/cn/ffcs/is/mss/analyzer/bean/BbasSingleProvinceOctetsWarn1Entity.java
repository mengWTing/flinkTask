...
@Entity
@Table(name = "BBAS_SINGLE_PROVINCE_OCTETS_WARN1", schema = "SDFS", catalog = "")
@IdClass(BbasSingleProvinceOctetsWarn1EntityPK.class)
public class BbasSingleProvinceOctetsWarn1Entity {
    ...
    public boolean equals(Object o) {
        ...
        BbasSingleProvinceOctetsWarn1Entity that = (BbasSingleProvinceOctetsWarn1Entity) o;
