 ...
 */
@Entity
@Table(name = "BBAS_IP_PORT_DESTINATION_REGRESSION", schema = "SDFS", catalog = "")
@IdClass(BbasIpPortDestinationRegressionEntityPK.class)
public class BbasIpPortDestinationRegressionEntity {
    ...
    public boolean equals(Object o) {
        ...
        BbasIpPortDestinationRegressionEntity that = (BbasIpPortDestinationRegressionEntity) o;
