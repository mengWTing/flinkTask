...
@Entity
@Table(name = "BBAS_SINGLE_PROVINCE_USERCOUNT_WARN1", schema = "SDFS", catalog = "")
@IdClass(BbasSingleProvinceUsercountWarn1EntityPK.class)
public class BbasSingleProvinceUsercountWarn1Entity {
    ...
    public boolean equals(Object o) {
        ...
        BbasSingleProvinceUsercountWarn1Entity that = (BbasSingleProvinceUsercountWarn1Entity) o;
