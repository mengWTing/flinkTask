 ...
 */
@Entity
@Table(name = "BBAS_SINGLE_SYSTEM_CONNCOUNT_WARN", schema = "SDFS", catalog = "")
@IdClass(BbasSingleSystemConncountWarnEntityPK.class)
public class BbasSingleSystemConncountWarnEntity {
    ...
    public boolean equals(Object o) {
        ...
        BbasSingleSystemConncountWarnEntity that = (BbasSingleSystemConncountWarnEntity) o;
