 ...
 */
@Entity
@Table(name = "BBAS_SINGLE_PROVINCE_CONNCOUNT_REGRESSION", schema = "SDFS", catalog = "")
@IdClass(BbasSingleProvinceConncountRegressionEntityPK.class)
public class BbasSingleProvinceConncountRegressionEntity {
    ...
    public boolean equals(Object o) {
        ...
        BbasSingleProvinceConncountRegressionEntity that = (BbasSingleProvinceConncountRegressionEntity) o;
