 ...
 */
@Entity
@Table(name = "BBAS_SINGLE_PROVINCE_USERCOUNT_WARN", schema = "SDFS", catalog = "")
@IdClass(BbasSingleProvinceUsercountWarnEntityPK.class)
public class BbasSingleProvinceUsercountWarnEntity {
    ...
    public boolean equals(Object o) {
        ...
        BbasSingleProvinceUsercountWarnEntity that = (BbasSingleProvinceUsercountWarnEntity) o;
