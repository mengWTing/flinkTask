 ...
 */
@Entity
@Table(name = "BBAS_SINGLE_SYSTEM_CONNCOUNT_REGRESSION", schema = "SDFS", catalog = "")
@IdClass(BbasSingleSystemConncountRegressionEntityPK.class)
public class BbasSingleSystemConncountRegressionEntity {
    ...
    public boolean equals(Object o) {
        ...
        BbasSingleSystemConncountRegressionEntity that = (BbasSingleSystemConncountRegressionEntity) o;
