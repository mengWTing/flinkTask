 ...
 */
@Entity
@Table(name = "BBAS_ALL_USER_USERCOUNT_WARN", schema = "SDFS", catalog = "")
public class BbasAllUserUsercountWarnEntity {
    ...
    public boolean equals(Object o) {
        ...
        BbasAllUserUsercountWarnEntity that = (BbasAllUserUsercountWarnEntity) o;
