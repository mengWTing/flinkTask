 ...
 */
@Entity
@Table(name = "BBAS_SYSTEM_PORT_DESTINATION_WARN_PORT_CONFIG", schema = "SDFS", catalog = "")
public class BbasSystemPortDestinationWarnPortConfigEntity {
    ...
    public boolean equals(Object o) {
        ...
        BbasSystemPortDestinationWarnPortConfigEntity that = (BbasSystemPortDestinationWarnPortConfigEntity) o;
