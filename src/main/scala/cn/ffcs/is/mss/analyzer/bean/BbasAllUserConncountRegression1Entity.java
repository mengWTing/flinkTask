...
@Entity
@Table(name = "BBAS_ALL_USER_CONNCOUNT_REGRESSION1", schema = "SDFS", catalog = "")
public class BbasAllUserConncountRegression1Entity {
    ...
    public boolean equals(Object o) {
        ...
        BbasAllUserConncountRegression1Entity that = (BbasAllUserConncountRegression1Entity) o;
