 ...
 */
@Entity
@Table(name = "BBAS_SYSTEM_PORT_SOURCE_WARN_IP_CONFIG", schema = "SDFS", catalog = "")
public class BbasSystemPortSourceWarnIpConfigEntity {
    ...
    public boolean equals(Object o) {
        ...
        BbasSystemPortSourceWarnIpConfigEntity that = (BbasSystemPortSourceWarnIpConfigEntity) o;
