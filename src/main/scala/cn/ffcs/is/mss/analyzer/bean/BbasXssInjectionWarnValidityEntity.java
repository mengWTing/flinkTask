...
/**
 * @author PlatinaBoy
 * @title BbasXssInjectionWarnValidityEntity
 * @date 2021-03-24 09:18
 * @description
 * @update [no][date YYYY-MM-DD][name][description]
 */
@Entity
@Table(name = "BBAS_XSS_INJECTION_WARN_VALIDITY", schema = "SDFS", catalog = "")
public class BbasXssInjectionWarnValidityEntity {
    ...
    public boolean equals(Object o) {
        ...
        BbasXssInjectionWarnValidityEntity that = (BbasXssInjectionWarnValidityEntity) o;
