 ...
 */
@Entity
@Table(name = "BBAS_IP_PORT_SOURCE_REGRESSION_CONFIG", schema = "SDFS", catalog = "")
@IdClass(BbasIpPortSourceRegressionConfigEntityPK.class)
public class BbasIpPortSourceRegressionConfigEntity {
    ...
    public boolean equals(Object o) {
        ...
        BbasIpPortSourceRegressionConfigEntity that = (BbasIpPortSourceRegressionConfigEntity) o;
