...
@Entity
@Table(name = "BBAS_SINGLE_SYSTEM_CONNCOUNT_WARN1", schema = "SDFS", catalog = "")
@IdClass(BbasSingleSystemConncountWarn1EntityPK.class)
public class BbasSingleSystemConncountWarn1Entity {
    ...
    public boolean equals(Object o) {
        ...
        BbasSingleSystemConncountWarn1Entity that = (BbasSingleSystemConncountWarn1Entity) o;
