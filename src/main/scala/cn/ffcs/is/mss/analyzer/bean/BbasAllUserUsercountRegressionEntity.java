 ...
 */
@Entity
@Table(name = "BBAS_ALL_USER_USERCOUNT_REGRESSION", schema = "SDFS", catalog = "")
public class BbasAllUserUsercountRegressionEntity {
    ...
    public boolean equals(Object o) {
        ...
        BbasAllUserUsercountRegressionEntity that = (BbasAllUserUsercountRegressionEntity) o;
