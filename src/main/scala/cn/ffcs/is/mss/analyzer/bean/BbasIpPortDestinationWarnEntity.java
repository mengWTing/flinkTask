 ...
 * @Auther chenwei
 * @Description
 * @Date: Created in 2017/12/21 15:05
 * @Modified By
 */
@Entity
@Table(name = "BBAS_IP_PORT_DESTINATION_WARN", schema = "SDFS", catalog = "")
@IdClass(BbasIpPortDestinationWarnEntityPK.class)
public class BbasIpPortDestinationWarnEntity {
    ...
    public boolean equals(Object o) {
        ...
        BbasIpPortDestinationWarnEntity that = (BbasIpPortDestinationWarnEntity) o;
