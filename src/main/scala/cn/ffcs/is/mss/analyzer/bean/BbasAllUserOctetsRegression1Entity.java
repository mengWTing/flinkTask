...
@Entity
@Table(name = "BBAS_ALL_USER_OCTETS_REGRESSION1", schema = "SDFS", catalog = "")
public class BbasAllUserOctetsRegression1Entity {
    ...
    public boolean equals(Object o) {
        ...
        BbasAllUserOctetsRegression1Entity that = (BbasAllUserOctetsRegression1Entity) o;
