 ...
 */
@Entity
@Table(name = "IPAS_IP_VISIT_WARN2", schema = "SDFS", catalog = "")
@IdClass(IpasIpVisitWarn2EntityPK.class)
public class IpasIpVisitWarn2Entity {
    ...
    public boolean equals(Object o) {
        ...
        IpasIpVisitWarn2Entity that = (IpasIpVisitWarn2Entity) o;
